            ...
            <div key={a.studentId} className="bg-white rounded-xl border border-gray100 p-4 md:p-5">
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  >
                    <Call size={18} className="md:hidden" variant="Bold" />
                    <Call size={14} className="hidden md:block" variant="Bold" />
                  </a>
                  <a
                  ...
                  >
                    <Sms size={18} className="md:hidden" variant="Bold" />
                    <Sms size={14} className="hidden md:block" variant="Bold" />
                  </a>
                </div>
              </div>
