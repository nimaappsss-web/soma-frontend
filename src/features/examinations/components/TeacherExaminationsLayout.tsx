...
const tabs = [
  { label: "Scoring", to: "/teach/exams/scoring" },
  { label: "Active", to: "/teach/exams/active" },
];
  ...
  return (
    <div className="flex flex-col min-h-full">
      <div className="p-4 md:p-6 pb-0 w-full">
        ...
        <div className="flex gap-1 max-w-[11rem] mb-4 rounded-full bg-gray100 p-1">
          {tabs.map((tab) => (
            <NavLink
              key={tab.to}
              to={tab.to}
...
export const TeacherExaminationsIndex = () => <Navigate to="scoring" replace />;
