...
export const teacherNavItems: NavItem[] = [
  ...
  { label: "My Class", to: "/teach/students", Icon: Profile2User },
  {
    label: "CA & Exams",
    ...
    hasCaret: true,
    children: [
      { label: "Subject Scores", to: "/teach/ca-and-exams/mark-scores" },
      { label: "My Class Scores", to: "/teach/ca-and-exams/my-class" },
